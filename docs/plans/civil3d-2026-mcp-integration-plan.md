...
**M1 decision update:** The owner subsequently placed and approved M1 in Phase 4 through [ADR-0011](../adr/0011-phase4-local-handoff-mcp.md), the [approved design](../superpowers/specs/2026-09-24-local-handoff-mcp-design.md), and the [implementation plan](../superpowers/plans/2026-09-24-local-handoff-mcp-implementation.md). The M1 decision prompts below are historical; implementation remains subject to the separate roadmap reservation removal.
